...
public class PointsMallProducts implements Serializable {
    ...
    private List<MallProductsPicture> mallProductsPicture;

    public List<MallProductsPicture> getMallProductsPicture() {
        return mallProductsPicture;
    }

    public void setMallProductsPicture(List<MallProductsPicture> mallProductsPicture) {
        this.mallProductsPicture = mallProductsPicture;
    }
